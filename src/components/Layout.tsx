...
export type View = "pipeline" | "leads" | "reunioes" | "agendas_time" | "performance" | "metas" | "comissoes" | "contratos" | "equipe" | "dashboard" | "blackbox" | "leadbroker" | "auditoria" | "prepcall" | "3c_manual" | "roleta_historico" | "playbook" | "perf_sdr" | "perf_visual" | "call_quality" | "geral" | "prospeccao" | "hub_dashboard" | "hub_outbound" | "canais" | "disparos" | "email_disparos";
...
export const Layout: React.FC<{
  ...
  const allNavItems = [
    ...
    { id: "canais" as const, label: "Análise de Canais", icon: Radar, badge: "novo" },
